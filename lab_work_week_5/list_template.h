...
template<typename T>
void List<T>::Add_To_Head(T data) {
...
template<typename T>
void List<T>::Add_To_Tail(T data) {
    if (this->list_elem == nullptr) {
        this->list_elem = new element(data);
    }
    else {
...
template<typename T>
int List<T>::Search_and_replace(int position, T key) {
    int res{ 0 };
    int iter{ 0 };
    element* temp = this->list_elem;
    while (temp != nullptr) {
...
template<typename T>
void List<T>::Add_in_position(int position, T data) {
    int iter{ 0 };
    int quont{ 0 };
    element* temp = this->list_elem;
    while (temp != nullptr) {
...
template<typename T>
void List<T>::Delete_from_position(int position) {
    if (position == 0) {
